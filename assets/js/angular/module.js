...
var AccountsList = function () {
	...
	_createClass(AccountsList, [{
		key: '_initNanoScrollWithDelay',
		value: function _initNanoScrollWithDelay() {
			this._$timeout(this._initNanoScroll.bind(this));
		}
	}, {
		key: '_initNanoScroll',
		value: function _initNanoScroll() {
...
var GlobalSettings = function () {
	...
	_createClass(GlobalSettings, [{
		...
		value: function $onInit() {
			...
			$body.on('wp-tinymce-change', this._doAutocompleteKeyUp.bind(this));
		...
		value: function _updatePostData(status) {
			...
			if (null === content) content = this.post.content;
...
var MessageTwitter = function (_MessageCommon) {
    ...
    _createClass(MessageTwitter, [{
            ...
            function TwitterCharacterUtil(maxWeiht) {
                ...
                function getTweetData(str, postfix) {
                    ...
                    if (str) {
                        ...
                        var newStr = str.replace(filterLinksRegex, '');
                    ...
                    if (str) {
                        d.tweetLength += links.length * urlLength;
                        d.links = links;
        ...
        value: function doAutocomplete() {
            ...
            if ('click-button' != this.global.post.autocompleteStatus) return;

            this._$timeout(function () {
                _this3._$msg.trigger('keyup');
            });
        }
    }]);
